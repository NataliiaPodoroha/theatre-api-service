...
from theatre_service.serializers import PlayListSerializer, PlayDetailSerializer
...
class AdminPlayApiTests(TestCase):
    ...
    def test_create_play_with_genres(self):
        genre1 = Genre.objects.create(name="Romance")
        genre2 = Genre.objects.create(name="Drama")
        payload = {
            "title": "Romeo and Juliet",
            "genres": [genre1.id, genre2.id],
            "description": "Tragedy about the romance between two youths from feuding families.",
        }
        res = self.client.post(PLAY_URL, payload)
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
    ...
    def test_create_play_with_actors(self):
        ...
        actor2 = Actor.objects.create(first_name="Claire", last_name="Danes")
        payload = {
            "title": "Romeo and Juliet",
